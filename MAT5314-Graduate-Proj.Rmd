...
We first gathered all relevant information into a formal data definition:
...
```{r, echo=FALSE, fig.align='center', fig.cap = "INARPQX(1) Process MSE with MLE Approximation", out.height="2in", out.width="6in"}
