...
From the previous analysis we have found that the ARIMA model did not yield a good prediction. One obvious flaw was that the predicted number of earthquake per month wasn't integer. We therefore introduce another model proposed by [@PQX].
...
```{r, echo=FALSE, fig.align='center', fig.cap = "INARPQX(1) Process Prediction", out.height="3in", out.width="3in"}
